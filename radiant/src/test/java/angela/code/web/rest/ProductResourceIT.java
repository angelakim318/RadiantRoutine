...
class ProductResourceIT {
    ...
    private static final ProductType DEFAULT_PRODUCT_TYPE = ProductType.TONER;
    private static final ProductType UPDATED_PRODUCT_TYPE = ProductType.ESSENCE;
    ...
    private static final UsageType DEFAULT_USAGE_TYPE = UsageType.CURRENTLY_USING;
    private static final UsageType UPDATED_USAGE_TYPE = UsageType.NOT_USING;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getUsageType()).isEqualTo(DEFAULT_USAGE_TYPE);
    }
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].usageType").value(hasItem(DEFAULT_USAGE_TYPE.toString())));
    }
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.usageType").value(DEFAULT_USAGE_TYPE.toString()));
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getUsageType()).isEqualTo(UPDATED_USAGE_TYPE);
    }
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.usageType(UPDATED_USAGE_TYPE);
